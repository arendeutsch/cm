...
describe("PremiumRecipeCard.vue", () => {
  ...
  beforeEach(() => {
    ...
    recipe = {
      ...
      "isDeleted": false,
      "status": "ok",
      "title": "Low Carb Buffalo Chicken Mac And Cheese W Smashed Cauliflower Medallions",
      "images": [
        {
          "id": "1:img",
          "url": "https://images.carbmanager.com/iYKrSEf7P6EAGx3desxGmcPJTVea2lJoBiXom24tevA/resize:fit:535/L2Fzc2V0cy5jYXJibWFuYWdlci5jb20vby91c2VyJTJGNGdkMlJoRVpqM2NGR1NKWDVuYjhFQzROWjBEMiUyRmltYWdlcyUyRmJiNmExNjY4LTU1NDMtNGE3Ny1hMDQ0LWQ0ODVhM2U0ZDMwNS5qcGc_YWx0PW1lZGlh"
        }
      ],
      "rating": {
        "count": 200,
  ...
  it("when user setting is KJ calories should not be retured", () => {
    const energy = 106;
    recipe.details.energy = energy;
    user.energyUnits = "KJ";
    const wrapper = shallowMount(PremiumRecipeCard, {
  ...
  it("when user setting is KJ calories should be converted to KJ", () => {
    const energy = 950;
    recipe.details.energy = energy;
    user.energyUnits = "KJ";
    const wrapper = shallowMount(PremiumRecipeCard, {
